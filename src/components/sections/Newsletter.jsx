  ...
  return (
    <div className="container mt-16 lg:mt-24">
      <div className="flex items-center">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-chow-yellow-soft shrink-0">
      ...
      <form onSubmit={onSubmit} className="mt-8 flex items-center h-16 rounded-full border-2 border-white/20 bg-white/5 backdrop-blur-sm overflow-hidden max-w-2xl">
        <input
          type="email"
          required
          value={email}
        ...
        <button
          type="submit"
          className="shrink-0 h-full px-6 md:px-8 bg-chow-yellow text-black font-semibold hover:bg-chow-yellow-soft transition-colors cursor-pointer"
        >
          Subscribe
        </button>
      </form>
